        ...
        <div className="items-center min-h-screen px-6 mx-auto align-middle mt-36 md:mt-0 md:flex md:max-w-4xl pb-36 md:pb-0">
            ...
            <motion.div
                ...
                transition={motionTransitionsAbout.transition}>
                    ...
                    <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Voluptatem nesciunt esse aliquam recusandae quibusdam quod accusantium quos nobis, libero cum exercitationem error vel, tempore assumenda excepturi beatae dignissimos, deleniti quasi!</p>
                        ...
                        {dataCounter.map(({id, endCounter, text, lineRight, lineRightMobile}) => (
                            <div key={id} className={`${lineRight ? 'ltr' : ''}`}>
                                <div className={`${lineRight} && 'px-4 border-2 border-transparent md:border-e-gray-100'} ${lineRightMobile && 'border-e-gray-100'}`}>
                                    ...
                                    <p 
                                        className="text-xs uppercase max-w-[100px]">
                                        {text}
                                    </p>
                                </div>
                            </div>
